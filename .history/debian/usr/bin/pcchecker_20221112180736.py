...
class DialogExample(Gtk.Dialog):
    def __init__(self, parent):
        ...
        self.lbl_alarm.set_markup("<span font='13'>"+_("When the alarm is turned on, an alarm is displayed in a pop-up window for the item whose security status is dangerous.")+"</span>")
...
class Application:
    ...
    def fnt_close_timeshift(self,widget):
        ...
        # set backup gui
        self.builder.get_object("exlabel4").set_markup(_("<b>Back up</b>                                                                                                                             " + ts_status))
        self.builder.get_object("exlabel44").set_markup(_(ts_info))
