...
class DialogExample(Gtk.Dialog):
    def __init__(self, parent):
        ...
        self.lbl_alarm.set_markup("<span font='13'>알람을 켜면 보안 상태가 '위험'인 항목\n에 대해서 팝업창으로 알람이 보여집니\n다.</span>")
...
class Application:
    ...
    def __init__(self):
        ...
        self.builder.get_object("label7").set_markup("<span font='13'><b>제품번호</b></span> : <span>"+uuid_val+"</span>")
