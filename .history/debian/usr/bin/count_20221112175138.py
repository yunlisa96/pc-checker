...
def set_score():
    ...
    if 100 == total_score_val:
        ...
        total_status_text = "<span color='green' font='80'><b>"+_("안전")+"</b></span>"
        total_info_text = "<span>"+_("시스템이 안전합니다.")+"</span>"
    elif 70 < total_score_val:
        total_score_text = "<span color='orange' font='40'><b>" + str(total_score_val) + "</b></span><span><b>/100</b></span>"
        total_status_text = "<span color='orange' font='80'><b>"+_("주의")+"</b></span>"
        total_info_text = "<span>"+_("시스템 관리에 주의가 필요합니다.")+"</span>"
    else:
        total_score_text = "<span color='red' font='40'><b>" + str(total_score_val) + "</b></span><span><b>/100</b></span>"
        total_status_text = "<span color='red' font='80'><b>"+_("위험")+"</b></span>"
        total_info_text = "<span>"+_("시스템을 관리해 주시기 바랍니다.")+"</span>"
