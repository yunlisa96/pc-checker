...
class DialogExample(Gtk.Dialog):
    def __init__(self, parent):
        super().__init__(title="Alarm settings", flags=0)
        self.add_buttons(
        ...
        self.lbl_alarm.set_markup("<span font='13'>When the alarm is turned on, an alarm is displayed in a pop-up window for the item\n whose security status is 'dangerous'.</span>")
...
class Application:
    ...
    def __init__(self):
        ...
        self.builder.get_object("label7").set_markup("<span font='13'><b>Product no</b></span> : <span>"+uuid_val+"</span>")
        self.builder.get_object("label2").set_markup("<span font='13'><b>Operating system</b></span> : <span>"+os_info+"</span>")
        self.builder.get_object("label3").set_markup("<span font='13'><b>Memory</b></span> : <span>"+memory_name+"</span>")
        self.builder.get_object("label4").set_markup("<span font='13'><b>Hard drive</b></span> : <span>"+disk_val+"GB</span>")
        ...
        self.builder.get_object("exlabel1").set_markup("<b>Password</b>                                                                                                                     " + pw_status)
        self.builder.get_object("exlabel2").set_markup("<b>Upgrade</b>                                                                                                                 " + update_status)
        self.builder.get_object("exlabel3").set_markup("<b>Firewall</b>                                                                                                                         " + ufw_status)
        self.builder.get_object("exlabel4").set_markup("<b>Back up</b>                                                                                                                             " + ts_status)
