...
def set_password():
    ...
    if 30 >= pw_date:
        ...
        pw_past = _("After password change")+" <span color='green'><b> " + str(pw_date) + "</b></span>"+_("days have passed.")
    elif 90 >= pw_date:
        pw_status = "<span background='orange' font='15' color='white'><b>"+_("Caution")+" </b></span>"
        pw_past = _("After password change")+"<span color='orange'><b> " + str(pw_date) + "</b></span>"+_("days have passed.")
    else:
        pw_status = "<span background='red' font='15' color='white'><b> "+_("Danger")+" </b></span>"
        pw_past = _("After password change")+"<span color='red'><b> " + str(pw_date) + "</b></span>"+_("days have passed.")
...
def set_update(osname):
    ...
    if 5 >= update_list:
        ...
        update_info = _("Upgradeable packages")+"<span color='green'><b>" + str(update_list) + "</b></span> 개 있습니다."
    else:
        update_status = "<span background='orange' font='15' color='white'><b> "+_("Caution")+" </b></span>"
        update_info = _("Upgradeable packages")+"<span color='orange'><b>" + str(update_list) + "</b></span> 개 있습니다."
