...
class Application:
    ...
    def __init__(self):
        ...
        self.builder.get_object("exlabel1").set_markup("<b>"+_("Password")+"</b>                                                                                                                            " + pw_status)
        self.builder.get_object("exlabel2").set_markup("<b>"+_("Upgrade")+"</b>                                                                                                                              " + update_status)
        self.builder.get_object("exlabel3").set_markup("<b>"+_("Firewall")+"</b>                                                                                                                                " + ufw_status)
        self.builder.get_object("exlabel4").set_markup("<b>"+_("Back up")+"</b>                                                                                                                                " + ts_status)
        ...
        self.builder.get_object("label31").set_markup(_(total_status_text))
        self.builder.get_object("label41").set_markup(_(total_info_text))
        self.builder.get_object("label42").set_markup(_(total_score_text))
    ...
    if 100 == total_score_val:
        ...
        total_status_text = "<span color='green' font='80'><b>Safety</b></span>"
        total_info_text = "<span>Your system is safe.</span>"
    elif 70 < total_score_val:
        total_score_text = "<span color='orange' font='40'><b>" + str(total_score_val) + "</b></span><span><b>/100</b></span>"
        total_status_text = "<span color='orange' font='80'><b>Caution</b></span>"
        total_info_text = "<span>System administration needs attention.</span>"
    else:
        total_score_text = "<span color='red' font='40'><b>" + str(total_score_val) + "</b></span><span><b>/100</b></span>"
        total_status_text = "<span color='red' font='80'><b>Danger</b></span>"
        total_info_text = "<span>Please manage the system.</span>"
        self.builder.get_object("label31").set_markup(_(total_status_text))
        self.builder.get_object("label41").set_markup(_(total_info_text))
        self.builder.get_object("label42").set_markup(_(total_score_text))
